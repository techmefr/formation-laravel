...
return [
    ...
    */
    ...
    'authorizations' => [
        'enabled' => true,
        'cache' => [
            // Désactivé : le cache sérialise du Illuminate\Auth\Access\Response en base
            // (CACHE_STORE=database) et son unserialize plante ("incomplete object"),
            // ce qui fait échouer l'autorisation même pour un utilisateur valide.
            'enabled' => false,
